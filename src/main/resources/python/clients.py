...
logger.info("Requesting all the RTC client servers from the repository.")
...
# by the helper.
response.entity = repository_helper.get_filtered_cis("lm.RTCClientServer", parent="Configuration")
