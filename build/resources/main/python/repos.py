...
logger.info("Requesting all the Repo configuration CI's from the repository.")
...
# by the helper.
response.entity = repository_helper.get_filtered_cis("lm.RTCConfigRepo", parent="Configuration")
